...
def pipeline_enem():
    ...
    def emr_process_enem_data():
        cluster_id = client.run_job_flow(
            Name='EMR-Pasini-IGTI',
            ServiceRole='EMR_DefaultRole',
            JobFlowRole='EMR_EC2_DefaultRole',
            VisibleToAllUsers=True,
            LogUri='s3://datalake-pasini-tf/emr-logs',
            ...
            Steps=[{
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ['spark-submit',
                            ...
                            '--master', 'yarn',
                            '--deploy-mode', 'cluster',
                            's3://datalake-pasini-tf/emr-code/pyspark/01_delta_spark_insert.py'
                        ]
                }
            }],
        )
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                ...
                                '--master', 'yarn',
                                '--deploy-mode', 'cluster',
                                's3://datalake-pasini-tf/emr-code/pyspark/02_delta_spark_upsert.py'
                            ]
                    }
                }]
            )
